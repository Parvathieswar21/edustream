        ...
        <div className="lg:col-span-1 space-y-8">
          <section className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 relative overflow-hidden">
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className="text-sm text-slate-500 font-medium mb-6">Student ID: #{profile?.id}</p>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="grid grid-cols-2 gap-6">
            <button
              ...
              className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center space-x-4 hover:border-indigo-500 transition-all group"
            >
            ...
            <button
              ...
              className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center space-x-4 hover:border-emerald-500 transition-all group"
            >
